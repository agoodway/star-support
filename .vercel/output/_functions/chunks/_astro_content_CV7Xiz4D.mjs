import { O as AstroError, P as LiveContentConfigError, A as AstroUserError, o as objectType, Q as dateType, n as numberType, h as arrayType, s as stringType, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, T as escape, J as unescapeHTML, a as renderTemplate, V as renderUniqueStylesheet, W as renderScriptElement, X as createHeadAndContent, r as renderComponent } from './astro/server_CeKHpNWz.mjs';
import { c as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_D-ejEcpP.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_WpRXS0pC.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_C8dZNa5U.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_DnLjQJJ4.mjs');
...
export { CONTENT_LAYER_TYPE as C, LIVE_CONTENT_TYPE as L, getEntry as a, defineCollection as d, getCollection as g, pLimit as p, renderEntry as r };
