...
import 'kleur/colors';
import { e as englishPages, c as isMediaEntry } from './content_DZ93dYAP.mjs';
...
const $$MediaGuidesNav = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$MediaGuidesNav;
...
}, "/Users/chasepursley/Development/ai/star-support/src/components/MediaGuidesNav.astro", void 0);

export { $$MediaGuidesNav as $ };
